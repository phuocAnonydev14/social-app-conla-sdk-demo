...
import type { IEntryPointSimulations, IEntryPointSimulationsInterface } from "../../../../@account-abstraction/contracts/interfaces/IEntryPointSimulations";
export declare class IEntryPointSimulations__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IEntryPointSimulations;
}
