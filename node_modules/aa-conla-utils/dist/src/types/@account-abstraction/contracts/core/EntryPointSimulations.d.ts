...
export interface EntryPointSimulationsInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_validateSenderAndPaymaster" | "addStake" | "balanceOf" | "delegateAndRevert" | "depositTo" | "deposits" | "getDepositInfo" | "getNonce" | "getSenderAddress" | "getUserOpHash" | "handleAggregatedOps" | "handleOps" | "incrementNonce" | "innerHandleOp" | "nonceSequenceNumber" | "simulateHandleOp" | "simulateValidation" | "supportsInterface" | "unlockStake" | "withdrawStake" | "withdrawTo"): FunctionFragment;
