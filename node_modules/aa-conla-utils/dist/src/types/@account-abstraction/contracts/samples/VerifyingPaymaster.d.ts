...
export interface VerifyingPaymasterInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addStake" | "deposit" | "entryPoint" | "getDeposit" | "getHash" | "owner" | "parsePaymasterAndData" | "postOp" | "renounceOwnership" | "transferOwnership" | "unlockStake" | "validatePaymasterUserOp" | "verifyingSigner" | "withdrawStake" | "withdrawTo"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getHash", values: [
...
export interface VerifyingPaymaster extends BaseContract {
    ...
    functions: {
        ...
        getHash(userOp: PackedUserOperationStruct, validUntil: PromiseOrValue<BigNumberish>, validAfter: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        parsePaymasterAndData(paymasterAndData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[
            number,
            number,
            string
        ] & {
    ...
    estimateGas: {
        ...
        getDeposit(overrides?: CallOverrides): Promise<BigNumber>;
        getHash(userOp: PackedUserOperationStruct, validUntil: PromiseOrValue<BigNumberish>, validAfter: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getHash(userOp: PackedUserOperationStruct, validUntil: PromiseOrValue<BigNumberish>, validAfter: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
