...
export interface SimpleAccountInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "UPGRADE_INTERFACE_VERSION" | "addDeposit" | "entryPoint" | "execute" | "executeBatch" | "getDeposit" | "getNonce" | "initialize" | "onERC1155BatchReceived" | "onERC1155Received" | "onERC721Received" | "owner" | "proxiableUUID" | "supportsInterface" | "upgradeToAndCall" | "validateUserOp" | "withdrawDepositTo"): FunctionFragment;
...
export interface SimpleAccount extends BaseContract {
    ...
    functions: {
        ...
        executeBatch(dest: PromiseOrValue<string>[], value: PromiseOrValue<BigNumberish>[], func: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        executeBatch(dest: PromiseOrValue<string>[], value: PromiseOrValue<BigNumberish>[], func: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<void>;
        getDeposit(overrides?: CallOverrides): Promise<BigNumber>;
        getNonce(overrides?: CallOverrides): Promise<BigNumber>;
