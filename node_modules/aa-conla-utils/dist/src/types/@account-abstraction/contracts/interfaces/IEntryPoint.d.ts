...
export interface IEntryPointInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addStake" | "balanceOf" | "delegateAndRevert" | "depositTo" | "getDepositInfo" | "getNonce" | "getSenderAddress" | "getUserOpHash" | "handleAggregatedOps" | "handleOps" | "incrementNonce" | "unlockStake" | "withdrawStake" | "withdrawTo"): FunctionFragment;
