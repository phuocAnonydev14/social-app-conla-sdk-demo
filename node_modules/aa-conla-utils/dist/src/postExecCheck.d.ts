...
export declare function postExecutionDump(entryPoint: IEntryPoint, userOpHash: string): Promise<void>;
/**
 ...
 * @param userOpHash
 */
export declare function postExecutionCheck(entryPoint: IEntryPoint, userOpHash: string): Promise<{
    gasUsed: number;
    gasPaid: number;
    success: boolean;
