...
import { IEntryPoint, UserOperation } from 'aa-conla-utils';
...
export declare class ERC4337EthersProvider extends BaseProvider {
    ...
    constructor(chainId: number, config: ClientConfig, originalSigner: Signer, originalProvider: BaseProvider, httpRpcClient: HttpRpcClient, entryPoint: IEntryPoint, smartAccountAPI: BaseAccountAPI);
    /**
    ...
    constructUserOpTransactionResponse(userOp: UserOperation): Promise<TransactionResponse>;
